(() => {
    ...
    function initSliders() {
        buildSliders();
        if (document.querySelector(".slider-pop-advantages")) new swiper_core_Swiper(".slider-pop-advantages", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-method__button--left",
                nextEl: ".slider-method__button--right"
            },
            on: {}
        });
    }
    ...
    const texts = [ "Идеальный сайт", "Реальный рост дохода", "Чистый код" ];
    let currentIndex = 0;
    function changeText() {
        ...
        setTimeout((() => {
            ...
            if (heroTitle.textContent === "Реальный рост дохода") heroTitle.classList.add("color"); else heroTitle.classList.remove("color");
